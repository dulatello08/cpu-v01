...
// Updated for big-endian, 72-bit (9-byte) instruction format.
//
...
module decode_unit_tb;
  ...
  logic        clk;
  logic        rst;
  logic [71:0] inst_data;  // 9 bytes max (padded to 72 bits)
  logic [3:0]  inst_len;
  logic [31:0] pc;
  logic        valid_in;
  logic        valid_out;
  ...
  initial begin
    ...
    // [sp(8)] [opcode(8)] = [00] [00]
    // Bit positions: [71:64][63:56]
    inst_data = 72'h00_00_00_00_00_00_00_00_00;
    inst_len = 4'd2;
    pc = 32'h0000_0100;
    valid_in = 1'b1;
    @(posedge clk);
    ...
    // Bits: [71:64][63:56][55:48][47:40][39:32]
    inst_data = 72'h00_01_01_12_34_00_00_00_00;
    inst_len = 4'd5;
    valid_in = 1'b1;
    @(posedge clk);
    #1;
    ...
    inst_data = 72'h01_01_02_03_00_00_00_00_00;
    inst_len = 4'd4;
    @(posedge clk);
    #1;
    assert(opcode == OP_ADD) else $error("Opcode mismatch");
    ...
    inst_data = 72'h00_09_05_AB_CD_00_00_00_00;
    inst_len = 4'd5;
    @(posedge clk);
    #1;
    ...
    inst_data = 72'h00_0A_12_34_56_78_00_00_00;
    inst_len = 4'd6;
    @(posedge clk);
    #1;
    ...
    inst_data = 72'h00_0C_01_02_AB_CD_00_00_00;
    inst_len = 4'd8;
    @(posedge clk);
    #1;
    ...
    inst_data = 72'h00_12_00_00_00_00_00_00_00;
    inst_len = 4'd2;
    @(posedge clk);
    #1;
    ...
    inst_data = 72'h00_10_01_02_03_00_00_00_00;
    inst_len = 4'd5;
    @(posedge clk);
    #1;
