...
The NeoCore16x32 instruction set consists of **26 opcodes** organized into 7 functional categories. All instructions use **big-endian byte ordering** and have **variable lengths** from 2 to 9
.
